# Short n-body (pure Python). Call-heavy inner loops (advance/energy) that PyPy
# inlines deeply; small step count keeps it warmup-bound.
import sys
...
def main(n):
    ...
    offset_momentum(BODIES['sun'], bodies)
